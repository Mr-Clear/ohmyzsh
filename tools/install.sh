...
#   bash -c "$(curl -fsSL https://raw.githubusercontent.com/Mr-Clear/ohmyzsh/arch/tools/install.sh)"
# or wget:
#   bash -c "$(wget -qO- https://raw.githubusercontent.com/Mr-Clear/ohmyzsh/arch/tools/install.sh)"
#
# As an alternative, you can first download the install script and run it afterwards:
#   wget https://raw.githubusercontent.com/Mr-Clear/ohmyzsh/arch/tools/install.sh
#   bash install.sh
#
