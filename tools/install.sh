...
#   bash -c "$(curl -fsSL https://raw.githubusercontent.com/Mr-Clear/ohmyzsh/debian/tools/install.sh)"
# or wget:
#   bash -c "$(wget -qO- https://raw.githubusercontent.com/Mr-Clear/ohmyzsh/debian/tools/install.sh)"
#
